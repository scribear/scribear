...
import { SessionControlsPanel } from '#src/features/session-controls/components/session-controls-panel';
import { KioskSplitLayout } from '#src/features/kiosk-split-screen/components/kiosk-split-layout';
import { useAppDispatch, useAppSelector } from '#src/store/use-redux';

/**
 * Host touchscreen: same shell as kiosk-webapp (split layout + drawers), with
 * the room session controls panel in place of the kiosk status panel.
 */
