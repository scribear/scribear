...
/**
 * Built-in preset color themes available to users.
 *
 * Each entry is a `PresetThemeConfig` with a unique `id`, a human-readable
 * `name`, and hex color values for `backgroundColor`, `accentColor`, and
 * `transcriptionColor`. These are displayed in the {@link PresetThemeSelector}
 * popover and can be applied atomically via `applyPresetTheme`.
 */
