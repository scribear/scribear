...
const EXCHANGE_DEVICE_TOKEN_SCHEMA = {
  description:
    'Exchange a device token for a session token and session refresh token. Source devices receive SEND_AUDIO + RECEIVE_TRANSCRIPTIONS; non-source devices receive RECEIVE_TRANSCRIPTIONS only.',
