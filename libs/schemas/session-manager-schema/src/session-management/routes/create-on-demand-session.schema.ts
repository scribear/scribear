...
const CREATE_ON_DEMAND_SESSION_SCHEMA = {
  description:
    'Create an on-demand session starting immediately. Rejected if another session is currently active in the room.',
...
const CREATE_ON_DEMAND_SESSION_ROUTE: BaseRouteDefinition = {
  method: 'POST',
  url: `${SESSION_MANAGER_BASE_PATH}/session-management/create-on-demand-session`,
};
